...
def upload_to_supabase(file_path, bucket_name="certificates", destination_path=None):
    """
    Uploads a file to Supabase Storage using environment variables or HTTP API.
    Env Vars Required: SUPABASE_URL, SUPABASE_KEY (or SUPABASE_SERVICE_ROLE_KEY)
    """
